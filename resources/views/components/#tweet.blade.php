...
<div  class="bg-white dark:bg-gray-400 text-gray-900 dark:text-white text-gray-600 dark:text-gray-400 border border-blue-500 rounded-lg py-6 px-8 mb-4">

    <textarea name="" class="w-full p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400" placeholder="what's up Doc?" id="" cols="30" rows="5" autofocus></textarea>

    <div class="flex justify-between">
        <div>
        <img src="{{asset('assets/img/messenger.svg')}}" width="30" height="20" alt="">
    </div>
    <div>
        <button class="bg-blue-400 rounded-full text-white shadow-sm px-2 py-2">Tweet-a-roo!</button>
    </div>
...
<div class=" flex items-centr justify-center  mb-2">
	...
	<div class="w-full max-w-xl border border-gray-300 rounded-2xl py-3 px-5">
		<div class="flex">
			<div class="mr-2">
				<img class="rounded-full" src="https://pbs.twimg.com/profile_images/1364491704817098753/V22-Luf7_normal.jpg" alt="Elon" /></div>
				<div>
			...
			<div class="py-3">
				<p class="text-lg">No highs, no lows, only Doge</p>
				<div class="flex">
