    ...
    <ul class="mt-6">
        ...
        <li class="relative px-6 py-3">
            <span class="absolute inset-y-0 left-0 w-1 {{request()->is('profile') ? 'bg-purple-600 rounded-tr-lg rounded-br-lg' : ''}}  "
                aria-hidden="true"></span>
            <a href="{{route('profile',auth()->user())}}" class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                >
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
